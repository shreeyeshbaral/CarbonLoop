...
export function AssetCard({ asset, onRequest }: AssetCardProps) {
  ...
  return (
    <>
      <div className="rounded-2xl bg-surface border border-border/80 p-5 shadow-card hover:shadow-hover hover:border-forest/40 transition-all duration-200 flex flex-col justify-between group relative">
        <div>
          {/* Top Badges Row */}
          <div className="flex items-center justify-between gap-2 mb-3">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <button
                ...
                className="p-1 rounded-lg hover:bg-canvas text-ink-muted hover:text-forest transition-colors"
          ...
          <div className="p-2.5 rounded-xl bg-canvas border border-border/50 text-xs text-ink-muted space-y-1 mb-3">
            <div className="flex items-center justify-between">
              <span className="flex items-center gap-1 font-medium text-ink truncate max-w-[200px]">
